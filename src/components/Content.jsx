...
const Container = styled.div`
  ...
  align-items: center;
  height: 100%;
  background-image: url("https://pbs.twimg.com/media/EVSj5d1UUAApVaZ?format=jpg&name=large");
...
const TitleTextArmory = styled.h1`
  font-size: 5rem;
  margin-bottom: 5rem;
...
const Button = styled.button`
  ...
  background-image: linear-gradient(-180deg, #fff, #658594);
  border-radius: 6px;
...
export default function Content() {
  function clickAccountHandler() {
    fetch(
      "https://wotlkarmory.netlify.app/https://wotlkarmory.netlify.app/api/users"
    )
  ...
  return (
    <Container>
      <TitleTextContainer>
        <TitleText>Wrath Of The Lich King</TitleText>
        <TitleTextArmory>A R M O R Y</TitleTextArmory>
      </TitleTextContainer>
      <ButtonDiv>
        <Button>UPLOAD CHARACTER</Button>
        <Button onClick={clickAccountHandler}>CREATE ACCOUNT</Button>
      </ButtonDiv>
      <Snowfall></Snowfall>
    </Container>
  );
